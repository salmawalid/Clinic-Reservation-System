...
def connect_to_mysql():
    return mysql.connector.connect(
        ...
        password='VARCHAR',  # Replace with your MySQL password
...
def register():
    ...
    try:
        ...
        if user_type == 'doctor':
            # If the user is a doctor, create an empty slot table for the doctor
            create_doctor_slots(username, connection)
